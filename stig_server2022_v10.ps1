...
## https://dl.dod.cyber.mil/wp-content/uploads/stigs/zip/U_MS_Windows_Server_2022_V1R1_STIG_SCAP_1-2_Benchmark.zip
...
###################################################
### AuditPol Status = Auditpol /get /category:* ###
###################################################
...
## Disables SMB2 but is required for Nessus Scans: Set-SmbServerConfiguration -EnableSMB2Protocol $false -Confirm:$false 
...
New-Item -force "HKLM:\SOFTWARE\Policies\Microsoft\Windows\AppCompat" -Name "DisableInventory" -Type DWord -Value 0x00000001

# Windows Server 2022 Autoplay must be turned off for nonvolume devices. 
New-Item -force "HKLM:\SOFTWARE\Policies\Microsoft\Windows\Explorer" -Name "NoAutoplayfornonVolume" -Type DWord -Value 0

# Windows Server 2022 default AutoRun behavior must be configured to prevent AutoRun commands. 
New-Item -force "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Explorer" -Name "NoAutorun"  -Type DWord -Value 1

# Windows Server 2022 AutoPlay must be disabled for all drives. 
New-Item -force "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\policies\Explorer" -Name "NoDriveTypeAutoRun" -Type DWord -Value 0x000000ff 
...
New-Item -force "HKLM:\SOFTWARE\Policies\Microsoft\Windows\DeliveryOptimization" -Name "DODownloadMode" -Type DWord -Value 0x00000064

# Windows Server 2022 Application event log size must be configured to 32768 KB or greater. 
New-Item -force "HKLM:\SOFTWARE\Policies\Microsoft\Windows\EventLog\Application" -Name "MaxSize" -Type DWord -Value 0x00008000
...
New-Item -force "HKLM:\SOFTWARE\Policies\Microsoft\Windows\Windows Search\" -name "AllowIndexingEncryptedStoresOrItems" -Type DWord -Value 1
...
New-Item -force "HKLM:\SOFTWARE\Policies\Microsoft\Windows\Installer" -Name "AlwaysInstallElevated" -Type DWord -Value 0x00000000
...
New-Item -force "HKLM:\SOFTWARE\Policies\Microsoft\Windows\WinRM\Client" -Name "AllowBasic" -Type DWord -Value 0x00000000
...
#############################################
### Rename Adminstrator and Guest Account ###
#############################################
...
New-Item -force "HKLM:\SYSTEM\CurrentControlSet\Control\Lsa" -Name "RestrictAnonymous" -Type DWord -Value 0x00000001
...
New-Item -force "HKLM:\SYSTEM\CurrentControlSet\Control\Lsa" -Name "LmCompatibilityLevel" -Type DWord -Value 0x00000005
...
# Fixes Nessus Scan Being Broken
New-Item -force "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System" -Name "LocalAccountTokenFilterPolicy" -Type DWord -Value 1
